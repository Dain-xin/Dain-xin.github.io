...
是由数组和链表实现的，初始长度是2^3，需要一个key-value的数据结构的集合，可以通过key访问value。因此产生了数组链表和散列机制。

![Java7_HashMap](https://blog-images-djx.oss-cn-hangzhou.aliyuncs.com/img/202206032120094.jpg)
...
![Java8_HashMap](https://blog-images-djx.oss-cn-hangzhou.aliyuncs.com/img/202206032119657.jpg)
